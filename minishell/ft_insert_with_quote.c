...
/*   Updated: 2024/10/23 15:44:11 by aduriez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void  init_data(t_insert_data *data, char *input,
                    int *j, t_echo *data_echo)
{
    data->input = input;
    data->iterator = 0;
    data->c = input[*data->i];
...
void ft_insert_data_w_whith_tab(t_echo *data_echo, char *input, int *i, int *j)
{
    t_insert_data   data;
